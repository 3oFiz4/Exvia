...
data class ThemePalette(
    ...
    fun primaryColor(): Int = safeColor(primary, "#F72323")
    fun secondaryColor(): Int = safeColor(secondary, "#CC0000")
    fun tertiaryColor(): Int = safeColor(tertiary, "#000000")
    fun quaternaryColor(): Int = safeColor(quaternary, "#1F1F1F")
    fun quinaryColor(): Int = safeColor(quinary, "#7D7D7D")
    fun senaryColor(): Int = safeColor(senary, "#EDEDED")
    ...
    companion object {
        ...
        private fun safeColor(value: String, fallback: String): Int = try {
